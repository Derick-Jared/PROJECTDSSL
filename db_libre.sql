...
--
-- Host: 127.0.0.1    Database: db_libre
-- ------------------------------------------------------
...
CREATE TABLE `detalle_venta` (
  ...
  KEY `fk_detalleventa_producto_idx` (`id_producto`),
...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_usuario_tipousuario_idx` (`id_tipousuario`),
  KEY `fk_usuario_persona_idx` (`id_persona`),
  CONSTRAINT `fk_usuario_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
  CONSTRAINT `fk_usuario_tipousuario` FOREIGN KEY (`id_tipousuario`) REFERENCES `tipo_usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `venta` (
  ...
  KEY `fk_venta_persona_idx` (`id_cliente`),
  CONSTRAINT `fk_venta_persona` FOREIGN KEY (`id_cliente`) REFERENCES `persona` (`id`),
...
-- Dump completed on 2024-12-27  1:13:32
